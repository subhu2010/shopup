...
<div class="seller-banner">
    <img src="{{asset('frontend/img/slider/slider-1.jpg')}}" alt="" class="img-fluid">
</div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="seller-info">
                    <div class="seller-img">
                        <img src="{{asset('frontend/img/bargain/br-3.png')}}" alt="" class="img-fluid">
                    </div>
                    <ul class="sellerl-info-list">
                        <li><span><i class="lar la-user"></i></span>Subash Khakurel</li>
                        <li><span><i class="las la-phone"></i></span>9808494404</li>
                        <li><span><i class="las la-map-marker-alt"></i></span>Harisiddhi-29, Lalitpur, Nepal</li>
                    </ul>
                    <div class="certified">
                        <p>Certificates</p>
                        <span class="certified-info">
            ...
            <div class="col-lg-8">
                <div class="seller-about">
                    <h1>About Subash Khakhurel</h1>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, laboriosam voluptates?
                        Officia, tempore. Molestias repellat consequatur cupiditate dolore ex! Ipsam quo tempora
                        asperiores alias sed culpa omnis, tempore itaque at harum excepturi similique ullam,
                        necessitatibus nesciunt autem dolores nisi? Amet, facere impedit quis, laudantium deserunt eos
                        expedita unde, consequatur labore culpa totam? Rerum earum incidunt porro quam ea eligendi
                        tempore odio similique ab qui quos, animi culpa aut, perferendis aspernatur! Ullam,
                        necessitatibus praesentium? Laudantium ut nemo vel corrupti natus nihil exercitationem eveniet
                        quo provident distinctio maiores recusandae delectus excepturi dolores voluptas at, voluptates
                        atque. Consequuntur, tempore quam? Quibusdam consequatur, dolorem est libero possimus rerum
                        molestiae excepturi exercitationem dolor voluptatum voluptate quisquam quasi quos tempora,
                        tempore quas fugit? Quam quos nam, eaque similique delectus dignissimos porro voluptas alias
                        reprehenderit repellat, consequatur quas maxime libero deserunt ipsum.
                    </p>
                </div>
            </div>
        </div>
...
<section class="products recomended-sec spacing" id="start">
    <div class="container">
        <div class="site-header">
            <h5>
                Products sold by Subash Khakurel
            </h5>
        </div>
        <ul class="row">
            <li class="products">
