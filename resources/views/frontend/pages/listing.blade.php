            ...
            <div class="row">
                <div class="col-lg-9 offset-lg-3">
                    <div class="site-header pt-0">
                        ...
                        <button class="btn d-lg-none" onclick="openFiler()">Apply Filter</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3">
                    @include("frontend.includes.listing-sidebar")
                </div>
                <div class="col-lg-9">
                    <div class="row row-cols-lg-3 row-cols-xl-4 row-cols-md-3 row-col-sm-2 custom">
