...
<div class="container">
    <div class="trending-btn">
        ...
        <ul class="trending-btn-group">
            <li><a href="javascrip:void(0)">Flash sale</a></li>
            <li><a href="javascrip:void(0)">popular products</a></li>
            <li><a href="javascrip:void(0)">new products</a></li>
            <li><a href="javascrip:void(0)">best sales</a></li>
            <li><a href="javascrip:void(0)">new arrivals</a></li>
            <li><a href="javascrip:void(0)">Recommended for you</a></li>
        </ul>
    </div>
</div>

<div class="list products mb-5">
    <div class="list__content">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 offset-lg-3">
                    <div class="site-header pt-0">
                        <h6>Showing <span>56 out of 523</span></h6>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="list-sidebar">
                        <div class="list__sidebar--block sideBar-height">
                            <h5>Brands</h5>
                            <form action="#">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Baby & Children Accesories</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Baby & Children Clothing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Jewellery</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Bags & Luggage</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Men's Accessories</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Men's Clothing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Men's Shoes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Sunglasses</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)">Thrift Store</a>
                                    </li>
                                </ul>
                            </form>
                        </div>
                        ...
                        <div class="list__sidebar--block sideBar-height">
                            ...
                            <form action="#">
                                <ul class="nav flex-column">
                                    <li class="nav-item ">
                                        <input type="checkbox" id="test1" name="checkbox-group" checked>
                                        <label for="test1">Bagmati Province</label>
                                    </li>
                                    <li class="nav-item">
                                        <input type="checkbox" id="test2" name="checkbox-group">
                                        <label for="test2">Gandaki province</label>
                                    </li>
                                    <li class="nav-item">
                                        <input type="checkbox" id="test3" name="checkbox-group">
                                        <label for="test3">Province 1</label>
                                    </li>
                                    <li class="nav-item">
                                        <input type="checkbox" id="test4" name="checkbox-group">
                                        <label for="test4">Madesh Province</label>
                                    </li>
                                </ul>
                            </form>
                        </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12"> 
                    <div class="row row-cols-lg-3 row-cols-xl-4 row-cols-md-2 row-col-sm-2 custom">
